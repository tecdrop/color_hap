...
/// The old key for the favorite colors list (JSON format). Used up to version 4.0.0 (inclusive).
const _oldColorFavoritesListKey = 'colorFavoritesList';

/// The key for the favorite colors list (key list format). Used since version 5.0.0.
const _colorFavoritesListKey = 'colorFavoritesKeyList';

/// The list of favorite colors.
var colorFavoritesList = ColorFavoritesList(
...
Future<void> loadSettings(Map<ColorType, RandomColorGenerator> generators) async {
  ...
  if (favKeyList == null || favKeyList.isEmpty) {
    ...
    final oldJsonList = oldPreferences.getStringList(_oldColorFavoritesListKey);
    ...
    if (oldJsonList != null && oldJsonList.isNotEmpty) {
      ...
      await oldPreferences.remove(_oldColorFavoritesListKey);
    }
  }
}
