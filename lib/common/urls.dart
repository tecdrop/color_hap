...
const viewSource = 'https://github.com/tecdrop/color_hap';

/// The URL to search for a color on the web (currently Google).
const onlineSearch = 'https://www.google.com/search?q=';
...
const _webRateUrl = 'https://go.tecdrop.com/colorhap/app/rate/web/';

/// The URL that allows the user to rate the ColorHap Android app (Google Play Store).
const _androidRateUrl =
